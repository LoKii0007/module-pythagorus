    ...
    <>
      <div className="overlay h-screen w-screen pointer-events-none fixed left-0 top-0 z-10 justify-center items-center flex">
       ...
       <div className="audio px-5 py-3 top-7 right-7 pointer-events-auto bg-slate-300 rounded-[20px] absolute "  >
        ...
        <div className="left-steps left-7 h-[60vh] absolute flex flex-col p-10 bg-slate-300 border-white border-2 rounded-[20px] pointer-events-auto min-w-fit w-[17vw] ">
          <button
            onClick={() => setActiveContent(activeContentTypes.introduction)}
          ...
          <button
            onClick={() => setActiveContent(activeContentTypes.example)}
        ...
        {activeContent === activeContentTypes.example && (
          <div className="pointer-events-auto bg-slate-300 p-5 rounded-[20px] absolute bottom-7 w-[250px] ">
            ...
            <input
              ...
              step="0.1"
              value={ans2}
              onChange={(e) => setAns2(Number(e.target.value))}
              className="w-full h-2 bg-green-500/30 rounded-lg appearance-none cursor-pointer"
            />

            <div className="w-full text-center mt-4 font-semibold text-xl " >{ans2}</div>
          </div>
        )}
      </div>
    </>
